...
<div x-show="searchOpen"
     ...
     style="display: none"
     role="dialog" aria-modal="true" aria-label="{{ __('site.search.dialog') }}">
    <div class="container-page pt-28 lg:pt-36"
        ...
        <form action="{{ route('search') }}" method="GET"
            ...
            <div class="flex items-center gap-3 px-6">
                ...
                <label for="site-search" class="sr-only">{{ __('site.search.term') }}</label>
            ...
            <div class="flex flex-wrap items-center gap-2 border-t border-sand-200 bg-sand-100 px-6 py-4 text-sm">
                <span class="text-ink-400">{{ __('site.search.popular') }}</span>
                @foreach((array) __('site.search.hints') as $hint)
