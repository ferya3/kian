            ...
            <div class="relative overflow-hidden rounded-[var(--radius-panel)] border border-ink-900/10 bg-ink-950 lg:col-span-8">
                ...
                @foreach($factorySections as $index => $section)
                    <button type="button"
                        ...
                        <span class="pointer-events-none absolute left-9 top-1/2 hidden -translate-y-1/2 whitespace-nowrap rounded-lg bg-ink-900/90 px-2.5 py-1 text-[0.75rem] text-sand-50 opacity-0 backdrop-blur transition-opacity duration-300 group-hover:opacity-100 lg:block"
                ...
                <p class="absolute bottom-4 right-5 text-[0.75rem] text-sand-200/40">
