    ...
    <section class="bg-sand-100 py-24 lg:py-32">
        <div class="container-page">
            <div class="mx-auto max-w-2xl text-center">
                <p class="tech text-7xl font-extrabold text-clay-500/30">۵۰۳</p>
                <h1 class="mt-4 text-h1 font-extrabold">سایت موقتاً در دسترس نیست</h1>
                <p class="mt-5 text-lead text-ink-500">
                    در حال به‌روزرسانی سایت هستیم. چند دقیقه دیگر برگردید
