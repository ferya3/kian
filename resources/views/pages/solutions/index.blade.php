<x-layouts.app>
    <x-page-hero
        eyebrow="Solutions"
        :title="__('site.solutions.title')"
        :lead="__('site.solutions.lead')" />
            ...
            @foreach($solutions as $solution)
                <article data-reveal
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <x-cta :href="route('solutions.show', $solution)" variant="ghost" size="sm" class="mt-6">{{ __('site.solutions.detail') }}</x-cta>
                    </div>

                    <div class="lg:col-span-4">
                        <h3 class="text-meta font-bold uppercase tracking-wider text-ink-400">{{ __('site.solutions.benefits') }}</h3>
                    ...
                    <div class="lg:col-span-3">
                        <h3 class="text-meta font-bold uppercase tracking-wider text-ink-400">{{ __('site.solutions.products') }}</h3>
