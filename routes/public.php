...
| صفحه‌های عمومی
|--------------------------------------------------------------------------
| این فایل یک‌بار و داخل گروهِ زبان ثبت می‌شود، پس هر مسیرش پیشوند زبان
| می‌گیرد: /fa/products و /en/products و /ar/products.
|
| نام‌ها بی‌پیشوند می‌مانند — products.index و نه en.products.index — و
| پارامتر locale را میان‌افزار SetLocale با URL::defaults پر می‌کند. برای
| همین هیچ فراخوانی route() در ویوها لازم نبود عوض شود.
*/
