...
|--------------------------------------------------------------------------
| قید از declaredCodes می‌آید و نه codes: هر زبانی که *اعلام* شده، حتی
| خاموشش. دو دلیل دارد و هر دو واقعی‌اند:
|
|   ۱. مسیرها یک‌بار ساخته و کش می‌شوند. با قیدِ زبان‌های روشن، خاموش‌کردنِ یک
|      زبان از پنل تا اجرای route:clear هیچ اثری نداشت — و بدتر، جدولِ کهنه
|      مسیرِ زبانِ خاموش را همچنان می‌خوراند.
|   ۲. زبانِ خاموش نباید ۴۰۴ بدهد. نشانی‌هایش جایی ذخیره و ایندکس شده‌اند؛
|      SetLocale با ۳۰۱ به همان صفحه در زبان پیش‌فرض می‌فرستدشان.
*/
Route::prefix('{locale}')
    ->where(['locale' => implode('|', Locales::declaredCodes())])
