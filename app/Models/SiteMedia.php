...
class SiteMedia extends Model
{
    ...
    public const SLOTS = [
         ...
         * شش ویژگیِ «چرا سفال؟».
         *
         * روی گوشی این بخش کاروسلی از شش کارتِ تصویری است و کارتِ بی‌عکس، طیفِ
         * مولد را نشان می‌دهد. تا وقتی عکسی آپلود نشده سایت درست کار می‌کند،
         * ولی جای این شش تصویر جای دیگری در پنل نبود.
         */
        'why.thermal' => ['تصویر «عایق حرارتی»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
        'why.acoustic' => ['تصویر «عملکرد صوتی»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
        'why.fire' => ['تصویر «مقاومت در برابر آتش»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
        'why.weight' => ['تصویر «سبکی و بار مرده»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
        'why.durability' => ['تصویر «دوام»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
        'why.natural' => ['تصویر «ماده‌ی طبیعی»', 'چرا سفال؟', 'کارت ویژگی در صفحه‌ی اصلی — مربع.'],
