...
class SiteMedia extends Model
{
    ...
    public const SLOTS = [
        ...
        /*
         * کارت پایانی «از خاک تا سازه» مرحله‌ی تولید نیست، پس ردیفی در
         * «مراحل تولید» ندارد که تصویرش را از آنجا بگیرد. تنها تصویر آن بخش
         * که جای دیگری قابل آپلود نبود، همین است.
         */
        'process.outcome' => [
            'تصویر کارت «و بعد، ساختمان»',
            'صفحه اصلی',
            'آخرین کارت بخش «از خاک تا سازه». تصویر ساختمانِ ساخته‌شده — مربع. تصویر نُه مرحله‌ی پیش از آن، در «مراحل تولید» آپلود می‌شود.',
        ],
